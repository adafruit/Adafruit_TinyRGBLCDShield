/*!
 * @file Adafruit_TinyRGBLCDShield.cpp
 *
 * @mainpage Adafruit Tiny RGB LCD Shield Library
 *
...
void Adafruit_TinyRGBLCDShield::init(uint8_t fourbitmode, uint8_t rs,
                                     uint8_t rw, uint8_t enable, uint8_t d0,
...
void Adafruit_TinyRGBLCDShield::begin(uint8_t cols, uint8_t lines,
                                      uint8_t dotsize) {
  // check if i2c
  if (_i2cAddr != 255) {
    //_i2c.begin(_i2cAddr);
...
void Adafruit_TinyRGBLCDShield::createChar(uint8_t location,
                                           uint8_t charmap[]) {
